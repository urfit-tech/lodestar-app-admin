...
// TODO: remove this after new export import completed
...
const OldMemberExportModal: React.FC<{
  appId: string
  ...
  const exportMemberList = async () => {
    try {
      ...
      const { data } = await client.query<
        hasura.GET_OLD_MEMBER_EXPORT_COLLECTION,
        hasura.GET_OLD_MEMBER_EXPORT_COLLECTIONVariables
      >({
        query: GET_OLD_MEMBER_EXPORT_COLLECTION,
        variables: {
          condition,
          orderBy,
        },
...
const GET_OLD_MEMBER_EXPORT_COLLECTION = gql`
  query GET_OLD_MEMBER_EXPORT_COLLECTION($condition: member_export_bool_exp!, $orderBy: [member_export_order_by!]) {
...
export default OldMemberExportModal