...
type BlogPublishingAdminPaneProps = CardProps & {
  post: PostType | null
  onRefetch?: () => void
}
const BlogPublishingAdminPane: React.FC<BlogPublishingAdminPaneProps> = ({ post, onRefetch }) => {
...
export default BlogPublishingAdminPane
