...
const PeriodPlanModal: React.FC<
...
> = ({
  ...
  const [upsertProgramPlan] = useMutation(UPSERT_PERIOD_PLAN)
...
const UPSERT_PERIOD_PLAN = gql`
  mutation UPSERT_PERIOD_PLAN(
    $programId: uuid!
    $id: uuid!
    $type: Int!
    $title: String!
...
`
export default PeriodPlanModal
