  ...
  const defaultMenuItems: {
    ...
    },
    {
      ...
      subMenuItems: [
        ...
        {
          permissionIsAllowed: !!enabledModules.membership_card && currentUserRole === 'app-owner',
          key: 'membership_card',
    ...
    {
      permissionIsAllowed:
        !!enabledModules.announcement &&
        (Boolean(permissions.ANNOUNCEMENT_ADMIN) || Boolean(permissions.ANNOUNCEMENT_VIEW)),
