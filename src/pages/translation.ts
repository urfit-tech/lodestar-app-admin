...
const pageMessages = {
  '*': defineMessages({
    delete: { id: 'page.*.delete', defaultMessage: 'Delete' },
    ...
    enrolledMember: {
      ...
      defaultMessage: 'Members with equity',
    },
    ...
    deleteProductDanger: { id: 'page.*.deleteProductDanger', defaultMessage: '*Purchasers can still watch after deletion.' },
    search: { id: 'page.*.search', defaultMessage: 'Search' },
    reset: { id: 'page.*.reset', defaultMessage: 'Reset' },
    import: { id: 'page.*.import', defaultMessage: 'Import' },
    certificateNumber: { id: 'page.*.certificateNumber', defaultMessage: 'Certificate number' },
    deliveryDate: { id: 'page.*.deliveryDate', defaultMessage: 'Delivery date' },
    expiryDate: { id: 'page.*.expiryDate', defaultMessage: 'Expiry date' },
    upload: { id: 'page.*.upload', defaultMessage: 'Upload' },
    discontinued: { id: 'page.*.discontinued', defaultMessage: 'Discontinued' },
    materialName: { id: 'page.*.materialName', defaultMessage: 'Material filename' },
    downloadedAt: { id: 'page.*.downloadedAt', defaultMessage: 'First download time' },
    programCategories: { id: 'page.*.programCategories', defaultMessage: 'Program categories' },
    programContentType: {
      id: 'page.*.programContentType',
      defaultMessage: 'Content type',
    },
    view: { id: 'page.*.view', defaultMessage: 'View' },
    allMembers: { id: 'page.*.allMembers', defaultMessage: 'All members' },
    totalSales: { id: 'page.*.totalSales', defaultMessage: 'Total sales' },
    dollar: { id: 'page.*.dollar', defaultMessage: 'dollar' },
  }),
  ProjectAdminPage: defineMessages({
    settings: { id: 'page.ProjectAdminPage.settings', defaultMessage: 'Project settings' },
    projectIntroduction: { id: 'project.ProjectAdminPage.projectIntroduction', defaultMessage: 'Project introduction' },
  ...
  ProjectFundingPage: defineMessages({
    projectTitle: { id: 'page.ProjectFundingPage.projectTitle', defaultMessage: 'Project title' },
    sponsor: { id: 'page.ProjectFundingPage.sponsor', defaultMessage: 'Sponsor' },
    unnamedProject: { id: 'page.ProjectFundingPage.unnamedProject', defaultMessage: 'Unnamed project' },
  }),
  ProjectPreOrderPage: defineMessages({
    projectTitle: { id: 'page.ProjectPreOrderPage.projectTitle', defaultMessage: 'Project title' },
    sponsor: { id: 'page.ProjectPreOrderPage.sponsor', defaultMessage: 'Sponsor' },
    unnamedProject: { id: 'page.ProjectPreOrderPage.unnamedProject', defaultMessage: 'Unnamed project' },
  }),
  ...
  ProgramProgressCollectionAdminPage: defineMessages({
    programProgress: { id: 'page.ProgramProgressCollectionAdminPage.programProgress', defaultMessage: 'Learning progress' },
  }),
  ProgramProcessBlock: defineMessages({
    chooseProgramCategory: {
      id: 'page.ProgramProcessBlock.chooseProgramCategory',
      defaultMessage: 'Choose program category',
    },
    chooseProgram: { id: 'page.ProgramProcessBlock.chooseProgram', defaultMessage: 'Choose program' },
    allPrograms: { id: 'page.ProgramProcessBlock.allPrograms', defaultMessage: 'All programs' },
    selectedProgram: { id: 'page.ProgramProcessBlock.selectedProgram', defaultMessage: 'Selected program' },
    chooseProperty: { id: 'page.ProgramProcessBlock.chooseProperty', defaultMessage: 'Choose field' },
    containKeyword: { id: 'page.ProgramProcessBlock.containKeyword', defaultMessage: 'Contains keyword' },
    programContentDuration: {
      id: 'page.ProgramProcessBlock.programContentDuration',
      defaultMessage: 'Content duration (minutes)',
    },
    watchedDuration: { id: 'page.ProgramProcessBlock.watchedDuration', defaultMessage: 'Learning time (minutes)' },
    watchedPercentage: {
      id: 'page.ProgramProcessBlock.watchedPercentage',
      defaultMessage: 'Learning progress',
    },
    firstWatchedAt: { id: 'page.ProgramProcessBlock.firstWatchedAt', defaultMessage: 'First watched at' },
    lastWatchedAt: { id: 'page.ProgramProcessBlock.lastWatchedAt', defaultMessage: 'Last watched at' },
    totalPercentage: { id: 'page.ProgramProcessBlock.totalPercentage', defaultMessage: 'Total completion rate' },
    exerciseStatus: { id: 'pageProgramProgressCollectionAdminPage.exerciseStatus', defaultMessage: 'Exercise status' },
    exercisePassed: { id: 'pageProgramProgressCollectionAdminPage.exercisePassed', defaultMessage: 'Passed' },
    exerciseFailed: { id: 'pageProgramProgressCollectionAdminPage.exerciseFailed', defaultMessage: 'Failed' },
    exerciseScores: { id: 'page.ProgramProcessBlock.exerciseScores', defaultMessage: 'Exercise scores' },
    exercisePassedAt: {
      id: 'page.ProgramProcessBlock.exercisePassedAt',
      defaultMessage: 'Exercise passed at',
    },
    practices: { id: 'page.ProgramProcessBlock.practices', defaultMessage: 'Practices' },
    learningDuration: { id: 'page.ProgramProcessBlock.learningDuration', defaultMessage: 'Learning hours' },
    learningProgress: { id: 'page.ProgramProcessBlock.learningProgress', defaultMessage: 'Learning progress' },
    exportProgramProgress: {
      id: 'page.ProgramProcessBlock.exportProgramProgress',
      defaultMessage: 'Export learning progress',
    },
    exportMaterialAuditLog: {
      id: 'page.ProgramProcessBlock.exportMaterialAuditLog',
      defaultMessage: 'Export material download records',
    },
    lastUpdatedAtText: {
      id: 'page.ProgramProcessBlock.lastUpdatedAtText',
      defaultMessage: 'Calculate cumulative progress up to this date',
    },
  }),
  AppointmentPeriodCollectionAdminPage: defineMessages({
    allInstructors: { id: 'page.AppointmentPeriodCollectionAdminPage.allInstructors', defaultMessage: 'All instructors' },
    emptyAppointment: {
      id: 'page.AppointmentPeriodCollectionAdminPage.emptyAppointment',
      defaultMessage: 'No appointments yet',
    },
    dateRangeWarning: {
      id: 'page.AppointmentPeriodCollectionAdminPage.dateRangeWarning',
      defaultMessage: 'Please select a time range within one month',
    },
  }),
  ProgramPackageProcessBlock: defineMessages({
    selectedProgramPackage: {
      id: 'page.ProgramPackageProcessBlock.selectedProgramPackage',
      defaultMessage: 'Selected program package',
    },
    chooseProgramPackageCategory: {
      id: 'page.ProgramPackageProcessBlock.chooseProgramPackageCategory',
      defaultMessage: 'Choose program package category',
    },
    selectedPackageCategory: {
      id: 'page.ProgramPackageProcessBlock.selectedPackageCategory',
      defaultMessage: 'Selected package category',
    },
    allProgramPackage: {
      id: 'page.ProgramPackageProcessBlock.allProgramPackage',
      defaultMessage: 'All program packages',
    },
    chooseProgramPackage: { id: 'page.ProgramPackageProcessBlock.chooseProgramPackage', defaultMessage: 'Choose program' },
    instructorName: {
  ...
  CouponCollectionBlock: defineMessages({
    ...
    emptyCouponPlan: {
      ...
      defaultMessage: 'No coupon plans',
    },
  }),
  ...
  ScheduleExpirySettingPage: defineMessages({
    languageChinese: { id: 'page.ScheduleExpirySettingPage.languageChinese', defaultMessage: '中文' },
    languageGerman: { id: 'page.ScheduleExpirySettingPage.languageGerman', defaultMessage: '德文' },
    languageJapanese: { id: 'page.ScheduleExpirySettingPage.languageJapanese', defaultMessage: '日文' },
    languageFrench: { id: 'page.ScheduleExpirySettingPage.languageFrench', defaultMessage: '法文' },
    languageEnglish: { id: 'page.ScheduleExpirySettingPage.languageEnglish', defaultMessage: '英文' },
    languageSpanish: { id: 'page.ScheduleExpirySettingPage.languageSpanish', defaultMessage: '西文' },
    languageKorean: { id: 'page.ScheduleExpirySettingPage.languageKorean', defaultMessage: '韓文' },
    languageTaiwanese: { id: 'page.ScheduleExpirySettingPage.languageTaiwanese', defaultMessage: '台語' },
    languageCantonese: { id: 'page.ScheduleExpirySettingPage.languageCantonese', defaultMessage: '粵語' },
    individualClass: { id: 'page.ScheduleExpirySettingPage.individualClass', defaultMessage: '個人班' },
    ...
    createdAt: { id: 'page.ScheduleExpirySettingPage.createdAt', defaultMessage: '建立日期' },
    archivedAt: { id: 'page.ScheduleExpirySettingPage.archivedAt', defaultMessage: '封存日期' },
    operator: { id: 'page.ScheduleExpirySettingPage.operator', defaultMessage: '操作人' },
    addRule: { id: 'page.ScheduleExpirySettingPage.addRule', defaultMessage: '新增規則' },
    addRuleSuccess: { id: 'page.ScheduleExpirySettingPage.addRuleSuccess', defaultMessage: '新增規則成功' },
    selectLanguage: { id: 'page.ScheduleExpirySettingPage.selectLanguage', defaultMessage: '請選擇語言' },
    inputClassCount: { id: 'page.ScheduleExpirySettingPage.inputClassCount', defaultMessage: '請輸入滿堂數' },
    inputValidDays: { id: 'page.ScheduleExpirySettingPage.inputValidDays', defaultMessage: '請輸入有效天數' },
    fillAllFields: { id: 'page.ScheduleExpirySettingPage.fillAllFields', defaultMessage: '請填寫所有必填欄位' },
    classCountExample: { id: 'page.ScheduleExpirySettingPage.classCountExample', defaultMessage: '例如：10' },
    validDaysExample: { id: 'page.ScheduleExpirySettingPage.validDaysExample', defaultMessage: '例如：1' },
  }),
}
