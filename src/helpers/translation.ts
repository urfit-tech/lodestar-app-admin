...
export const programMessages = {
  ...
  label: defineMessages({
    ...
    score: { id: 'program.label.points', defaultMessage: '單題分數' },
...
export const memberMessages = {
  ...
  label: defineMessages({
    ...
    editMemberNote: { id: 'member.label.editNote', defaultMessage: '編輯備註' },
    deleteMemberNote: { id: 'member.label.deleteProgram', defaultMessage: '刪除備註' },
