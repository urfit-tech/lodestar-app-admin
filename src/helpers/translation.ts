...
export const commonMessages = {
  ui: defineMessages({
    ...
    uploadMedia: { id: 'common.ui.uploadMedia', defaultMessage: '上傳圖片或影片' },
...
export const memberMessages = {
  ...
  text: {
    ...
    refundAppliedAt: { id: 'member.text.refundAppliedAt', defaultMessage: '於 {time} 完成解約' },
    loanCanceledAt: { id: 'member.text.loanCanceledAt', defaultMessage: '於 {time} 取消' },
    approvedAt: { id: 'member.text.approvedAt', defaultMessage: '於 {time} 通過' },
    startedAt: { id: 'member.text.startedAt', defaultMessage: '合約開始時間：{time}' },
    endedAt: { id: 'member.text.endedAt', defaultMessage: '合約結束時間：{time}' },
    serviceStartedAt: { id: 'member.text.serviceStartedAt', defaultMessage: '服務開始時間：{time}' },
    serviceEndedAt: { id: 'member.text.serviceEndedAt', defaultMessage: '服務結束時間：{time}' },
...
export const salesMessages = defineMessages({
  ...
  assignedAt: { id: 'sales.label.assignedAt', defaultMessage: '派發日期' },
  recentContactedAt: { id: 'sales.label.recentContactedAt', defaultMessage: '最近撥打' },
...
export const memberContractMessages = {
  ...
  label: defineMessages({
    ...
    revenueShare: { id: 'memberContract.label.revenueShare', defaultMessage: '業務分潤' },
