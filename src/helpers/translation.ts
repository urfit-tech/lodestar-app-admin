...
export const salesMessages = defineMessages({
  ...
  assignedLead: { id: 'sales.label.assignedLead', defaultMessage: '近期派發' },
  idledLead: { id: 'sales.label.idledLead', defaultMessage: '未撥打名單' },
  contactedLead: { id: 'sales.label.contactedLead', defaultMessage: '已撥打名單' },
