...
export const salesMessages = defineMessages({
  ...
  idledLead: { id: 'sales.label.idledLead', defaultMessage: '待開發' },
  contactedLead: { id: 'sales.label.contactedLead', defaultMessage: '待邀約' },
  invitedLead: { id: 'sales.label.invitedLead', defaultMessage: '已邀約' },
  presentedLead: { id: 'sales.label.presentedLead', defaultMessage: '已 Demo' },
