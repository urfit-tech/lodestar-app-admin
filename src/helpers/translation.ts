...
export const memberMessages = {
  ...
  status: {
    ...
    inbound: { id: 'profile.status.inbound', defaultMessage: '進線' },
    outbound: { id: 'profile.status.outbound', defaultMessage: '外撥' },
    answered: { id: 'profile.status.answered', defaultMessage: '已接聽' },
    missed: { id: 'profile.status.missed', defaultMessage: '未接聽' },
  },
  label: defineMessages({
    profile: { id: 'profile.label.profile', defaultMessage: '個人資料' },
    note: { id: 'profile.label.note', defaultMessage: '聯絡紀錄' },
    ...
    createMemberNote: { id: 'profile.label.createNote', defaultMessage: '新增紀錄' },
