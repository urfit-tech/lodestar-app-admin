...
export interface GET_PROGRAM_ENROLLMENT_program_enrollment_aggregate_aggregate {
  __typename: "program_enrollment_aggregate_fields";
  count: number | null;
}

export interface GET_PROGRAM_ENROLLMENT_program_enrollment_aggregate {
  __typename: "program_enrollment_aggregate";
  aggregate: GET_PROGRAM_ENROLLMENT_program_enrollment_aggregate_aggregate | null;
}
...
export interface GET_PROGRAM_ENROLLMENT {
   ...
   */
  program_enrollment_aggregate: GET_PROGRAM_ENROLLMENT_program_enrollment_aggregate;
}

export interface GET_PROGRAM_ENROLLMENTVariables {
  programId: any;
}
...
// ====================================================
// GraphQL mutation operation: UPDATE_PROGRAM_IN_ADVANCE
// ====================================================

export interface UPDATE_PROGRAM_IN_ADVANCE_update_program {
  __typename: "program_mutation_response";
  /**
   * number of affected rows by the mutation
   */
...
export interface UPDATE_PROGRAM_IN_ADVANCE {
  /**
   * update data of the table: "program"
   */
  update_program: UPDATE_PROGRAM_IN_ADVANCE_update_program | null;
}

export interface UPDATE_PROGRAM_IN_ADVANCEVariables {
  programId: any;
  inAdvance?: boolean | null;
}
...
// ====================================================
// GraphQL mutation operation: UPDATE_PROGRAM_PLAN
// ====================================================

export interface UPDATE_PROGRAM_PLAN_update_program_plan {
...
export interface UPDATE_PROGRAM_PLAN {
  /**
   * update data of the table: "program_plan"
   */
  update_program_plan: UPDATE_PROGRAM_PLAN_update_program_plan | null;
}

export interface UPDATE_PROGRAM_PLANVariables {
  programPlanId: any;
  listPrice: any;
  salePrice: any;
}
...
// ====================================================
// GraphQL query operation: GET_ACTIVTY_ADMIN
// ====================================================

export interface GET_ACTIVTY_ADMIN_activity_by_pk_activity_categories_category {
  __typename: "category";
  id: string;
  name: string;
}

export interface GET_ACTIVTY_ADMIN_activity_by_pk_activity_categories {
  __typename: "activity_category";
  id: any;
  /**
   * An object relationship
   */
  category: GET_ACTIVTY_ADMIN_activity_by_pk_activity_categories_category;
  position: number;
}

export interface GET_ACTIVTY_ADMIN_activity_by_pk_activity_enrollments_aggregate_aggregate {
  __typename: "activity_enrollment_aggregate_fields";
  count: number | null;
}

export interface GET_ACTIVTY_ADMIN_activity_by_pk_activity_enrollments_aggregate {
  __typename: "activity_enrollment_aggregate";
  aggregate: GET_ACTIVTY_ADMIN_activity_by_pk_activity_enrollments_aggregate_aggregate | null;
}

export interface GET_ACTIVTY_ADMIN_activity_by_pk_activity_sessions_activity_enrollments_aggregate_aggregate {
  __typename: "activity_enrollment_aggregate_fields";
  count: number | null;
}

export interface GET_ACTIVTY_ADMIN_activity_by_pk_activity_sessions_activity_enrollments_aggregate {
  __typename: "activity_enrollment_aggregate";
  aggregate: GET_ACTIVTY_ADMIN_activity_by_pk_activity_sessions_activity_enrollments_aggregate_aggregate | null;
}

export interface GET_ACTIVTY_ADMIN_activity_by_pk_activity_sessions {
  __typename: "activity_session";
  id: any;
  title: string;
  description: string | null;
   ...
   * An aggregated array relationship
   */
  activity_enrollments_aggregate: GET_ACTIVTY_ADMIN_activity_by_pk_activity_sessions_activity_enrollments_aggregate;
}

export interface GET_ACTIVTY_ADMIN_activity_by_pk_activity_tickets_activity_session_tickets_activity_session {
  __typename: "activity_session";
  id: any;
  title: string;
}

export interface GET_ACTIVTY_ADMIN_activity_by_pk_activity_tickets_activity_session_tickets {
  __typename: "activity_session_ticket";
  id: any;
  /**
   * An object relationship
   */
  activity_session: GET_ACTIVTY_ADMIN_activity_by_pk_activity_tickets_activity_session_tickets_activity_session;
}

export interface GET_ACTIVTY_ADMIN_activity_by_pk_activity_tickets_activity_ticket_enrollments_aggregate_aggregate {
  __typename: "activity_ticket_enrollment_aggregate_fields";
  count: number | null;
}

export interface GET_ACTIVTY_ADMIN_activity_by_pk_activity_tickets_activity_ticket_enrollments_aggregate {
  __typename: "activity_ticket_enrollment_aggregate";
  aggregate: GET_ACTIVTY_ADMIN_activity_by_pk_activity_tickets_activity_ticket_enrollments_aggregate_aggregate | null;
}

export interface GET_ACTIVTY_ADMIN_activity_by_pk_activity_tickets {
  __typename: "activity_ticket";
  id: any;
  title: string;
  description: string | null;
   ...
   * An array relationship
   */
  activity_session_tickets: GET_ACTIVTY_ADMIN_activity_by_pk_activity_tickets_activity_session_tickets[];
  /**
   * An aggregated array relationship
   */
  activity_ticket_enrollments_aggregate: GET_ACTIVTY_ADMIN_activity_by_pk_activity_tickets_activity_ticket_enrollments_aggregate;
}

export interface GET_ACTIVTY_ADMIN_activity_by_pk {
  __typename: "activity";
  id: any;
  title: string;
  description: string;
   ...
   * An array relationship
   */
  activity_categories: GET_ACTIVTY_ADMIN_activity_by_pk_activity_categories[];
  /**
   * An aggregated array relationship
   */
  activity_enrollments_aggregate: GET_ACTIVTY_ADMIN_activity_by_pk_activity_enrollments_aggregate;
  /**
   * An array relationship
   */
  activity_sessions: GET_ACTIVTY_ADMIN_activity_by_pk_activity_sessions[];
  /**
   * An array relationship
   */
  activity_tickets: GET_ACTIVTY_ADMIN_activity_by_pk_activity_tickets[];
}

export interface GET_ACTIVTY_ADMIN {
  /**
   * fetch data from the table: "activity" using primary key columns
   */
  activity_by_pk: GET_ACTIVTY_ADMIN_activity_by_pk | null;
}

export interface GET_ACTIVTY_ADMINVariables {
  activityId: any;
}
...
// ====================================================
// GraphQL query operation: GET_ACITIVTY_PARTICIPANTS
// ====================================================

export interface GET_ACITIVTY_PARTICIPANTS_activity_enrollment {
  __typename: "activity_enrollment";
...
export interface GET_ACITIVTY_PARTICIPANTS_activity_session {
  __typename: "activity_session";
  id: any;
  title: string;
  started_at: any;
...
export interface GET_ACITIVTY_PARTICIPANTS {
  /**
   * fetch data from the table: "activity_enrollment"
   */
  activity_enrollment: GET_ACITIVTY_PARTICIPANTS_activity_enrollment[];
  /**
   * fetch data from the table: "activity_session"
   */
  activity_session: GET_ACITIVTY_PARTICIPANTS_activity_session[];
}

export interface GET_ACITIVTY_PARTICIPANTSVariables {
  activityId: any;
}
...
export interface GET_PROGRAM_PACKAGE_CONTENT_program_package_by_pk_program_package_programs_program_program_content_sections_program_contents {
  __typename: "program_content";
  id: any;
  duration: any | null;
}

export interface GET_PROGRAM_PACKAGE_CONTENT_program_package_by_pk_program_package_programs_program_program_content_sections {
  __typename: "program_content_section";
  id: any;
  /**
   * An array relationship
   */
  program_contents: GET_PROGRAM_PACKAGE_CONTENT_program_package_by_pk_program_package_programs_program_program_content_sections_program_contents[];
}
...
export interface GET_PROGRAM_PACKAGE_CONTENT_program_package_by_pk_program_package_programs_program {
   ...
   * An array relationship
   */
  program_content_sections: GET_PROGRAM_PACKAGE_CONTENT_program_package_by_pk_program_package_programs_program_program_content_sections[];
}
...
export interface GET_OWNED_PROGRAMS_program_content_enrollment {
...
export interface GET_OWNED_PROGRAMS {
   ...
   */
  program_content_enrollment: GET_OWNED_PROGRAMS_program_content_enrollment[];
}
...
// ====================================================
// GraphQL query operation: GET_PROGRAM_BY_PROGRAM_PLAN_ID
// ====================================================

export interface GET_PROGRAM_BY_PROGRAM_PLAN_ID_program {
  __typename: "program";
  id: any;
}

export interface GET_PROGRAM_BY_PROGRAM_PLAN_ID {
  /**
   * fetch data from the table: "program"
   */
  program: GET_PROGRAM_BY_PROGRAM_PLAN_ID_program[];
}

export interface GET_PROGRAM_BY_PROGRAM_PLAN_IDVariables {
  programPlanId: any;
}
...
// ====================================================
// GraphQL query operation: GET_PROJECT_SALES
// ====================================================

export interface GET_PROJECT_SALES_project_sales {
  __typename: "project_sales";
  project_id: any | null;
  total_sales: any | null;
}

export interface GET_PROJECT_SALES_project_plan_enrollment_aggregate_aggregate {
  __typename: "project_plan_enrollment_aggregate_fields";
  count: number | null;
}

export interface GET_PROJECT_SALES_project_plan_enrollment_aggregate {
  __typename: "project_plan_enrollment_aggregate";
  aggregate: GET_PROJECT_SALES_project_plan_enrollment_aggregate_aggregate | null;
}

export interface GET_PROJECT_SALES {
  /**
   * fetch data from the table: "project_sales"
   */
  project_sales: GET_PROJECT_SALES_project_sales[];
  /**
   * fetch aggregated fields from the table: "project_plan_enrollment"
   */
  project_plan_enrollment_aggregate: GET_PROJECT_SALES_project_plan_enrollment_aggregate;
}

export interface GET_PROJECT_SALESVariables {
  projectId: any;
}
...
// ====================================================
// GraphQL query operation: GET_ENROLLED_PROEJCT_PLANS
// ====================================================

export interface GET_ENROLLED_PROEJCT_PLANS_project_plan_enrollment_project_plan_project {
  __typename: "project";
  id: any;
  title: string;
  expired_at: any | null;
...
export interface GET_ENROLLED_PROEJCT_PLANS_project_plan_enrollment_project_plan {
  __typename: "project_plan";
  id: any;
  title: string;
  description: string;
   ...
   * An object relationship
   */
  project: GET_ENROLLED_PROEJCT_PLANS_project_plan_enrollment_project_plan_project;
}

export interface GET_ENROLLED_PROEJCT_PLANS_project_plan_enrollment {
  __typename: "project_plan_enrollment";
  /**
   * An object relationship
   */
  project_plan: GET_ENROLLED_PROEJCT_PLANS_project_plan_enrollment_project_plan | null;
}

export interface GET_ENROLLED_PROEJCT_PLANS {
  /**
   * fetch data from the table: "project_plan_enrollment"
   */
  project_plan_enrollment: GET_ENROLLED_PROEJCT_PLANS_project_plan_enrollment[];
}

export interface GET_ENROLLED_PROEJCT_PLANSVariables {
  memberId: string;
}
...
// ====================================================
// GraphQL query operation: GET_PROGRAM_PLAN
// ====================================================

export interface GET_PROGRAM_PLAN_program_plan_by_pk_program {
  __typename: "program";
  cover_url: string | null;
}

export interface GET_PROGRAM_PLAN_program_plan_by_pk {
  __typename: "program_plan";
  id: any;
  title: string | null;
  /**
   * An object relationship
   */
  program: GET_PROGRAM_PLAN_program_plan_by_pk_program;
}

export interface GET_PROGRAM_PLAN {
  /**
   * fetch data from the table: "program_plan" using primary key columns
   */
  program_plan_by_pk: GET_PROGRAM_PLAN_program_plan_by_pk | null;
}

export interface GET_PROGRAM_PLANVariables {
  id: any;
}
...
export interface GET_ACTIVITY_COLLECTION_activity_activity_sessions_aggregate_aggregate_min {
  __typename: "activity_session_min_fields";
  started_at: any | null;
}

export interface GET_ACTIVITY_COLLECTION_activity_activity_sessions_aggregate_aggregate_max {
  __typename: "activity_session_max_fields";
  ended_at: any | null;
}

export interface GET_ACTIVITY_COLLECTION_activity_activity_sessions_aggregate_aggregate {
  __typename: "activity_session_aggregate_fields";
  min: GET_ACTIVITY_COLLECTION_activity_activity_sessions_aggregate_aggregate_min | null;
  max: GET_ACTIVITY_COLLECTION_activity_activity_sessions_aggregate_aggregate_max | null;
}

export interface GET_ACTIVITY_COLLECTION_activity_activity_sessions_aggregate {
  __typename: "activity_session_aggregate";
  aggregate: GET_ACTIVITY_COLLECTION_activity_activity_sessions_aggregate_aggregate | null;
}
...
export interface GET_ACTIVITY_COLLECTION_activity {
   ...
   * An aggregated array relationship
   */
  activity_sessions_aggregate: GET_ACTIVITY_COLLECTION_activity_activity_sessions_aggregate;
}
...
// ====================================================
// GraphQL query operation: GET_ACTIVITY_TIECKT
// ====================================================

export interface GET_ACTIVITY_TIECKT_activity_ticket_by_pk_activity {
  __typename: "activity";
  cover_url: string | null;
}

export interface GET_ACTIVITY_TIECKT_activity_ticket_by_pk {
  __typename: "activity_ticket";
  id: any;
  title: string;
  /**
   * An object relationship
   */
  activity: GET_ACTIVITY_TIECKT_activity_ticket_by_pk_activity;
}

export interface GET_ACTIVITY_TIECKT {
  /**
   * fetch data from the table: "activity_ticket" using primary key columns
   */
  activity_ticket_by_pk: GET_ACTIVITY_TIECKT_activity_ticket_by_pk | null;
}

export interface GET_ACTIVITY_TIECKTVariables {
  id: any;
}
...
// ====================================================
// GraphQL query operation: GET_CARD
// ====================================================

export interface GET_CARD_card_by_pk {
  __typename: "card";
  id: any;
  title: string;
}

export interface GET_CARD {
  /**
   * fetch data from the table: "card" using primary key columns
   */
  card_by_pk: GET_CARD_card_by_pk | null;
}

export interface GET_CARDVariables {
  id: any;
}
...
// ====================================================
// GraphQL query operation: GET_PROJECT_PLAN
// ====================================================

export interface GET_PROJECT_PLAN_project_plan_by_pk {
  __typename: "project_plan";
  id: any;
  title: string;
  cover_url: string | null;
...
export interface GET_PROJECT_PLAN {
  /**
   * fetch data from the table: "project_plan" using primary key columns
   */
  project_plan_by_pk: GET_PROJECT_PLAN_project_plan_by_pk | null;
}

export interface GET_PROJECT_PLANVariables {
  id: any;
}
...
// ====================================================
// GraphQL query operation: GET_PROGRAM_ISSUES
// ====================================================

export interface GET_PROGRAM_ISSUES_issue_issue_reactions {
  __typename: "issue_reaction";
  member_id: string;
}

export interface GET_PROGRAM_ISSUES_issue_issue_replies_aggregate_aggregate {
  __typename: "issue_reply_aggregate_fields";
  count: number | null;
}

export interface GET_PROGRAM_ISSUES_issue_issue_replies_aggregate {
  __typename: "issue_reply_aggregate";
  aggregate: GET_PROGRAM_ISSUES_issue_issue_replies_aggregate_aggregate | null;
}

export interface GET_PROGRAM_ISSUES_issue {
  __typename: "issue";
  id: any;
  title: string;
  thread_id: string;
   ...
   * An array relationship
   */
  issue_reactions: GET_PROGRAM_ISSUES_issue_issue_reactions[];
  /**
   * An aggregated array relationship
   */
  issue_replies_aggregate: GET_PROGRAM_ISSUES_issue_issue_replies_aggregate;
}

export interface GET_PROGRAM_ISSUES {
  /**
   * fetch data from the table: "issue"
   */
  issue: GET_PROGRAM_ISSUES_issue[];
}

export interface GET_PROGRAM_ISSUESVariables {
  appId: string;
