...
// ====================================================
// GraphQL query operation: GET_VALID_MEMBER_CONTRACT
// ====================================================

export interface GET_VALID_MEMBER_CONTRACT_member_contract_member {
  __typename: "member";
  id: string;
  name: string;
  email: string;
...
export interface xuemi_member_private_teach_contract_bool_exp {
  _and?: xuemi_member_private_teach_contract_bool_exp[] | null;
  _not?: xuemi_member_private_teach_contract_bool_exp | null;
  _or?: xuemi_member_private_teach_contract_bool_exp[] | null;
  agreed_at?: timestamptz_comparison_exp | null;
